...
<html>
    ...
    if ($GLOBALS['turn'] === 2){
        $users2->jouer($aiMoves->AIPlay(), 2);
        if ($users4->est_ganger($aiMoves->AIPlay() + 1)) {
        ...
        echo "C'est à ".(($turn == 1)? $j1 : $j2).' (<img src="'.(($turn == 1)? "Images/joueur1.png" : "Images/joueur2.png" ).'" alt="pionJoueur" height="15">) de jouer.'."\n"
    ?>
